...
gulp.task('watch', ['browser-sync','nunjucks','scripts'], function() {
	gulp.watch('app/sass/**/*.scss', ['sass']); // Наблюдение за sass файлами в папке sass
	gulp.watch('app/template/**/*.html', ['nunjucks', browserSync.reload]);
...
gulp.task('build', ['clean', 'img', 'sass', 'nunjucks', 'scripts'], function() {
